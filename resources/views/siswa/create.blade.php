...
<div class="container" style="margin-top: 35px;">
        ...
        <form method="POST" action="{{ route('siswa.store') }}">  @csrf
        ...
        <p><span class="error-message text-danger fw-600">@error('name') {{ $message }} @enderror</span></p>
            <table border="0">
                <tr>
                    <td><label for="nim">NIS</label></td>
                </tr>
                <tr>
                    <td><input class="inp" type="text" name="nis" placeholder="NIS"  required></td>
                    <span id="nim-error" class="error-message"></span>
                </tr>
                <tr>
                    <td><label>Nama Peserta Didik</label></td>
                </tr>
                <tr>
                    <td><input class="inp" type="text" name="nama" placeholder="Nama Peserta Didik" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="date" name="tgl_lahir" placeholder="Tanggal Lahir" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="jenkel" placeholder="Jenis Kelamin" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="alamat" placeholder="alamat" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="id_jurusan" placeholder="id_jurusan" required></td>
                </tr>
